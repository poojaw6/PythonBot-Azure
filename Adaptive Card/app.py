...
from adaptivecard.adaptivecard import SampleAdaptiveCard

app = Flask(__name__)
loop = asyncio.get_event_loop()

#botsettings = BotFrameworkAdapterSettings("47a2c4b3-08c2-47f9-a14e-5863fc30a159","C_9O-odp4vMFk~rOr5kLc260.NO1CxE9-u")
